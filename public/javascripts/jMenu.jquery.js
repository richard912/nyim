...
IF YOU ADD MODIFICATIONS,
IF YOU ADD ENHANCEMENTS,
THANKS TO CONTACT ME, IT WILL BE GREAT  :)   !! 
...
(function($){
	...
	$.jMenu = {
		...
		init:function(options){
			...
			$('#jMenu li a.fNiv').hover(function(){
				var $this = $(this);
		...
		****************************/
		...
		_show:function(el) {
			...
			{
				case 'slide':
					el.delay(opts.TimeBeforeOpening).slideDown(opts.effects.effectSpeedOpen, opts.effects.effectOpen);
					break;
				case 'fade':
					el.delay(opts.TimeBeforeOpening).fadeIn(opts.effects.effectSpeedOpen, opts.effects.effectOpen);
					break;
				default :
					el.delay(opts.TimeBeforeOpening).show(opts.effects.effectSpeedOpen, opts.effects.effectOpen);
			}
		},
